...
export async function signUp(
  ...
  // Verificar se o e-mail já está cadastrado (a trigger on_auth_user_created
  // cria a linha de profiles no ato do signup, antes da confirmação).
  ...
  return {
    ok: true,
    message:
      "Conta criada! Verifique sua caixa de entrada para confirmar seu e-mail. Após a confirmação, você poderá fazer login e vincular seu cadastro.",
  };
}
