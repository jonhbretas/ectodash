      ...
      <section className="flex w-full flex-col gap-4 rounded-2xl bg-white p-5 shadow-[0_1px_2px_rgba(0,0,0,0.04)] ring-1 ring-zinc-200/60">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            type="file"
            accept=".pdf,.md,.txt"
            className="block w-full cursor-pointer rounded-xl border border-zinc-300 bg-white px-4 py-3 text-lg text-zinc-900 file:mr-4 file:min-h-12 file:cursor-pointer file:rounded-lg file:border-0 file:bg-blue-700 file:px-4 file:text-lg file:font-medium file:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700"
          />
          ...
          <div className="flex flex-col gap-2">
            ...
            {meetingsError ? (
              ...
              <select
                ...
                name="reuniaoId"
                defaultValue=""
                className="min-h-14 w-full rounded-xl border border-zinc-300 bg-white px-4 text-lg text-zinc-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700"
              >
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className="min-h-40 w-full rounded-xl border border-zinc-300 bg-white px-4 py-3 text-lg text-zinc-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700"
          />
        </div>
      </section>
...
function AnalyseSubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="flex min-h-14 items-center justify-center gap-2 rounded-xl bg-blue-700 px-6 text-xl font-medium text-white shadow-[0_1px_3px_rgba(29,78,216,0.25)] transition-all duration-200 hover:bg-blue-600 hover:shadow-[0_2px_6px_rgba(29,78,216,0.3)] active:translate-y-px focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
    >
      {pending ? (
  ...
  return (
    <div className="flex w-full flex-col gap-6">
      <header className="flex w-full flex-wrap items-start justify-between gap-6">
        <div className="flex flex-col gap-1">
          <h1 className="flex items-center gap-2 text-3xl font-semibold text-zinc-900">
            <Sparkles size={30} aria-hidden="true" className="text-blue-700" />
...
function SaveSubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="flex min-h-14 w-full items-center justify-center gap-2 rounded-xl bg-green-700 px-6 text-xl font-medium text-white shadow-[0_1px_3px_rgba(21,128,61,0.25)] transition-all duration-200 hover:bg-green-600 hover:shadow-[0_2px_6px_rgba(21,128,61,0.3)] active:translate-y-px focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
    >
      {pending ? (
        <Loader2 size={22} aria-hidden="true" className="animate-spin" />
      ) : (
