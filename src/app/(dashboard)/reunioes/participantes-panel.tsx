  ...
  return (
    <section className="flex w-full flex-col gap-3 rounded-2xl bg-white p-5 shadow-[0_1px_2px_rgba(0,0,0,0.04)] ring-1 ring-zinc-200/60">
      <h2 className="flex items-center gap-2 text-2xl font-semibold text-zinc-900">
        ...
        Participantes
        {vinculados.length > 0 && (
          <span className="rounded-full bg-blue-50 px-2.5 py-0.5 text-base font-medium text-blue-800 ring-1 ring-blue-200/60">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {vinculados.map((v) => (
          <span
            key={v.id}
            className="flex items-center gap-1.5 rounded-full bg-blue-50 px-2.5 py-1 text-base font-medium text-blue-800 ring-1 ring-blue-200/60"
          ...
          >
            ...
            {canManage && (
              <button
                ...
                className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-blue-400 transition-all hover:bg-red-50 hover:text-red-600"
              >
