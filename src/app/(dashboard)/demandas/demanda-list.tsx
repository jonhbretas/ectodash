    ...
    <div className="flex w-full flex-col gap-6">
      ...
      {count === 0 && filtersActive ? (
        <div className="flex flex-col items-center gap-4 py-16 text-center">
          ...
          <Link
            href="/"
            className="flex min-h-14 items-center justify-center rounded-xl border border-zinc-300 bg-white px-4 py-3 text-xl font-medium text-zinc-900 transition-all duration-200 hover:bg-zinc-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700"
          >
            Limpar filtros
          </Link>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 py-16 text-center">
          ...
          <Link
            href="/demandas/nova"
            className="flex min-h-14 items-center justify-center rounded-xl bg-blue-700 px-5 text-xl font-medium text-white transition-all duration-200 hover:bg-blue-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700"
          >
            Nova demanda
          </Link>
        </div>
