  ...
  return (
    <article className="flex items-stretch gap-3 sm:gap-4">
      <div className="flex w-16 shrink-0 flex-col items-center justify-center gap-0.5 self-stretch rounded-2xl bg-white px-2 py-3 shadow-[0_1px_2px_rgba(0,0,0,0.04)] ring-1 ring-zinc-200/60 sm:w-20">
        ...
        {isToday && (
          <span className="mt-1 rounded-full bg-blue-700 px-2 py-0.5 text-sm font-semibold text-white">
            Hoje
          </span>
        )}
      </div>
      ...
      >
        ...
        <span className="mt-auto pt-1 text-base font-medium text-blue-700 underline decoration-blue-700/40 underline-offset-4">
          Gerenciar evento
        </span>
      </Link>
    </article>
