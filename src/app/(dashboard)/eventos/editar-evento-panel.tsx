...
const inputClass =
  "min-h-12 w-full rounded-xl border border-zinc-300 bg-white px-3 text-lg text-zinc-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700";
    ...
    >
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          className="rounded-xl border border-zinc-300 bg-white px-3 py-2 text-lg text-zinc-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700"
        />
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          type="submit"
          className="flex min-h-12 items-center gap-1.5 rounded-lg bg-blue-700 px-4 text-lg font-medium text-white transition-colors hover:bg-blue-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700"
        >
