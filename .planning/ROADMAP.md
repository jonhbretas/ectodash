...
- [x] 07-01-PLAN.md — Reminder-log schema (demanda_reminders_log dedup + reminder_runs), resend/react-email package-legitimacy checkpoint + install, eligibility classifier (wave 1)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 07-02-PLAN.md — CRON_SECRET-gated cron route: admin client, email template, dedup+send loop, run-log lifecycle (wave 2)
